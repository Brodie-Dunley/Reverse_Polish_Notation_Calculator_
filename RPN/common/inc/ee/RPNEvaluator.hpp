...
extern void one_arg_operation_int(std::shared_ptr<Token> operator_, std::stack<Operand::pointer_type>& stack_);
extern void two_arg_operation_int(std::shared_ptr<Token> operator_, std::stack<Operand::pointer_type>& stack_);
extern auto get_postfix_eval();
